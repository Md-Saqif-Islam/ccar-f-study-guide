...
1. **Volume 1 first.** The eight mental models make a large share of questions answerable on principle.
2. **Then the volume matching each domain**, weighted by how much of the exam it is and how weak you are in it.
3. **Do the official Anthropic courses**, particularly *Building with the Claude API*, *Introduction to MCP*, and *Claude Code in Action*. They are written by the people who wrote the exam.
4. **Sit the practice exam timed and unpaused** to find your weak domains, then restudy those.
5. **Sit a second practice exam from a different source.** Two independent scores agreeing is worth far more than one score.

---

## Honest caveats

- **These are unofficial.** The [official exam guide](https://www.anthropic.com/) is the authority. Where they disagree, believe the official guide.
...
- **Things move fast.** Model names, SDK signatures and Claude Code features change between releases. Details verified around July–August 2026. Check the docs for anything that looks off.
...
- Anthropic's official CCAR-F exam guide and the [Anthropic documentation](https://docs.claude.com)
- [claudecertificationguide.com](https://claudecertificationguide.com) — free, well-structured lessons that corrected several points in my own notes
